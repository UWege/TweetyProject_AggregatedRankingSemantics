...
public class CounterexamplesCatDbsBbsStrat {
    public static void main(String[] args) {
        ...
        // 2. Part: Whole Argumentationgraph
        ...
        // Counterexample for Copeland-aggregated, Borda-aggregated semantics (also ok for plurality)
        ...
        // der sieht gut aus! a<b für Cat und Strat und b>a für Dbsd und Bbsd
        // Gegenbeispiel für Copeland mit alpha>1 -> g>i vorher g=i
        DungTheory exTEST5 = new DungTheory();
        exTEST5.add(a, b, c, d, e, f);
        exTEST5.add(new Attack(a, a));
        exTEST5.add(new Attack(c, a));
        exTEST5.add(new Attack(c, b), new Attack(d, b));
        exTEST5.add(new Attack(e, c), new Attack(e, d));//, new Attack(e, d));
        exTEST5.add(new Attack(f, c));//, new Attack(f, d));

        DungTheory exTEST6 = new DungTheory();
        exTEST6.add(a, b, c, d, e, f, g, h, i, j, k, l, m);
        exTEST6.add(new Attack(a, a));
        exTEST6.add(new Attack(c, a));
        exTEST6.add(new Attack(c, b), new Attack(d, b));
        exTEST6.add(new Attack(e, c), new Attack(e, d));//, new Attack(e, d));
        exTEST6.add(new Attack(f, c));// new Attack(f, d)); //ohne Attack f,d!!

        exTEST6.add(new Attack(h, g), new Attack(k, g), new Attack(i, h), new Attack(j, h), new Attack(j, i), new Attack(l, k), new Attack(m, k), new Attack(l, m), new Attack(i, m), new Attack(j, m));


        DungTheory exTEST7 = new DungTheory();
        exTEST7.add(g, h, i, j, k, l, m);
        exTEST7.add(new Attack(h, g), new Attack(k, g), new Attack(i, h), new Attack(j, h), new Attack(j, i), new Attack(l, k), new Attack(m, k), new Attack(l, m), new Attack(i, m), new Attack(j, m));


        //Counterexample adm-Compatibility - Ex F_2
        ...
        System.out.println(aggPlur.getModel(exCPP).toString());
        ...
        /*
        aggPlur.getModel(ex2CP);
        aggCopeland0.getModel(ex2CP);
        aggCopeland05.getModel(ex2CP);
        aggCopeland1.getModel(ex2CP);
        aggBorda0.getModel(ex2CP);
        aggBorda05.getModel(ex2CP);
        aggBorda1.getModel(ex2CP);
        */
        ...
        System.out.println("Copeland:");
        System.out.println(aggCopeland0.getModel(exsComp).toString());
        System.out.println(aggCopeland05.getModel(exsComp).toString());
        System.out.println(aggCopeland1.getModel(exsComp).toString());
        ...
        System.out.println("Borda:");
        System.out.println(aggBorda0.getModel(exsComp).toString());
        System.out.println(aggBorda05.getModel(exsComp).toString());
        System.out.println(aggBorda1.getModel(exsComp).toString());
        ...
        System.out.println("Counterexample for Ordinal Equivalence ???? for Plurality-aggregated, Copeland-aggregated and Borda-aggregated semantics");
        System.out.println("Plurality:");
...
/*
        ...
        System.out.println(aggCopeland1.getModel(exTEST5).toString());
        System.out.println(aggCopeland05.getModel(exTEST5).toString());
        System.out.println(aggCopeland0.getModel(exTEST5).toString());
        System.out.println("exTest6:");
        System.out.println(aggCopeland1.getModel(exTEST6).toString());
        System.out.println(aggCopeland05.getModel(exTEST6).toString());
        System.out.println(aggCopeland0.getModel(exTEST6).toString());
        System.out.println("exTest7:");
        System.out.println(aggCopeland1.getModel(exTEST7).toString());
        System.out.println(aggCopeland05.getModel(exTEST7).toString());
        System.out.println(aggCopeland0.getModel(exTEST7).toString());

        System.out.println("exTest5:");
        aggCopeland1.getModel(exTEST5).printOrder();
        aggCopeland05.getModel(exTEST5).printOrder();
        aggCopeland0.getModel(exTEST5).printOrder();
        System.out.println("exTest6:");
        aggCopeland1.getModel(exTEST6).printOrder();
        aggCopeland05.getModel(exTEST6).printOrder();
        aggCopeland0.getModel(exTEST6).printOrder();
        System.out.println("exTest7:");
        aggCopeland1.getModel(exTEST7).printOrder();
        aggCopeland05.getModel(exTEST7).printOrder();
        aggCopeland0.getModel(exTEST7).printOrder();

        System.out.println("strat:");

        System.out.println(cat.getModel(exTEST6).toString());
        cat.getModel(exTEST6).printOrder();
        System.out.println(dbs.getModel(exTEST6).toString());
        System.out.println(bbs.getModel(exTEST6).toString());
        System.out.println(strat.getModel(exTEST6).toString());
        strat.getModel(exTEST6).printOrder();
